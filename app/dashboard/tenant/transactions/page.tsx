...
export default function TransactionsPage() {
  ...
  const transactions = [
    { id: 'TXN-2024-001', amount: 2500, waterUnits: 250, method: 'M-Pesa', status: 'Completed', date: '2024-01-15', time: '14:32' },
    { id: 'TXN-2024-002',  amount: 1850, waterUnits: 185, method: 'Bank Transfer', status: 'Completed', date: '2024-01-15', time: '12:15' },
    { id: 'TXN-2024-003',  amount: 3200, waterUnits: 320, method: 'M-Pesa', status: 'Pending', date: '2024-01-15', time: '10:45' },
    { id: 'TXN-2024-004',  amount: 1500, waterUnits: 150, method: 'Card', status: 'Completed', date: '2024-01-14', time: '16:20' },
    { id: 'TXN-2024-005',  amount: 2100, waterUnits: 210, method: 'M-Pesa', status: 'Failed', date: '2024-01-14', time: '09:30' },
    { id: 'TXN-2024-006',  amount: 1750, waterUnits: 175, method: 'Bank Transfer', status: 'Completed', date: '2024-01-14', time: '08:15' },
    { id: 'TXN-2024-007',  amount: 2800, waterUnits: 280, method: 'M-Pesa', status: 'Completed', date: '2024-01-13', time: '17:45' },
    { id: 'TXN-2024-008',  amount: 1950, waterUnits: 195, method: 'Card', status: 'Pending', date: '2024-01-13', time: '15:00' },
    { id: 'TXN-2024-009',  amount: 2300, waterUnits: 230, method: 'M-Pesa', status: 'Completed', date: '2024-01-13', time: '11:30' },
    { id: 'TXN-2024-010',  amount: 1650, waterUnits: 165, method: 'Bank Transfer', status: 'Completed', date: '2024-01-12', time: '14:00' },
  ]
  ...
  const handleExportExcel = async () => {
    ...
    // Create CSV content
    const headers = ['Transaction ID', 'Meter', 'Amount (KSH)', 'Water Units (L)', 'Method', 'Status', 'Date', 'Time']
    const csvContent = [
      headers.join(','),
      ...filteredTransactions.map(t => 
        [t.id,  t.amount, t.waterUnits, t.method, t.status, t.date, t.time].join(',')
      )
    ].join('\n')
